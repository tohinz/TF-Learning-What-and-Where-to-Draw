...
def generate_multi_image(single_images, num_images, image_dim, canvas_dim, bg=None,
    ...
    return canvas, placed_image_ids, placed_image_positions, placed_image_boxes, placed_image_transf_matr


def write_to_records(filename, images, indices, positions, boxes, labels, digits, transf_matr):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--min-width-scale", type=float, default=0.8)
    parser.add_argument("--max-width-scale", type=float, default=1.0)
    parser.add_argument("--min-height-scale", type=float, default=0.8)
    ...
    for num_digits in range(args.max_digits, args.max_digits + 1):
        ...
        for item in range(args.images_per_digit):
            img, ids, pos, box, transf_matr = generate_multi_image(
            ...
            strata_transf_matr.append(transf_matr)
        ...
        print("Writing {} digit images... ".format(num_digits), end="")
        write_to_records(MULTI_MNIST_FOLDER + str(num_digits), strata_images, strata_indices,
                         strata_positions, strata_boxes, strata_labels, strata_digits, strata_transf_matr)
        # save_as_array(MULTI_MNIST_FOLDER + str(num_digits), strata_images, strata_indices,
        ...
        if num_digits == args.max_in_common:
            ...
            print("Writing 0-{} digit images to common file... ".format(args.max_in_common), end="")
            ...
            print("Writing 0-{} digit images to test file... ".format(args.max_in_common), end="")
